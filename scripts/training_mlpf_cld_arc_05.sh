...
DATA_DIR="/gpfs/scratch/ehpc399/dolo/MLPF_data_Z_uds_clustering_dataset_3/"
CFG_DATA="config_files/config_hits_track_v4.yaml"
CFG_NET="src/models/wrapper/example_mode_gatr_noise.py"
MODEL_PREFIX="/gpfs/scratch/ehpc399/dolo/models_trained_CLD/20022026/"
				    ...
				    --batch-size 20 \
					    ...
					    --num-epochs 10 \
						    ...
						    --fetch-step 4 \
						        --condensation \
							    --log-wandb \
							        --wandb-displayname Zuds_05_paperdataset_baseline \
